...
<main class="pb-11">
            ...
            <div class="row">
                <div class="col-lg-9 flex items-center">
                    <nav id="breadcrumb_nav" class="flex items-center gap-x-5">
                        ...
                        <a href=""
                            class="text-light relative leading-tight transition-colors transition-300">Kurumsal</a>
                    </nav>
                </div>
                <div class="col-lg-3">
    ...
    <section id="page_content" class="pt-8 pb-25">
        <div class="container">
            <h2>Hakkımızda</h2>
            <p>
                ...
                sit amet..", comes from a line in section 1.10.32. Contrary to popular belief, Lorem Ipsum is not simply
    ...
    <section id="page_img" class="relative after-absolute -mb-11 mt-25">
        <img src="<?=domain?>assets/img/tasarlar.png" alt="Berasit Yaşam Alanları Tasarlar" class="block mx-auto relative z-1">
    </section>
</main>
